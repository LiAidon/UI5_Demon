sap.ui.define([
	...
	var CController = Controller.extend("ADTracker.controller.FACommBlock", {

		onInit: function () {
			// set mock model
			var sPath = jQuery.sap.getModulePath("ADTracker", "/feed.json")
			var oModel = new JSONModel(sPath);
			this.getView().setModel(oModel,"feed");
		},
